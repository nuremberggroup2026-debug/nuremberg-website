  ...
  return (
    <section className="py-60 text-center px-6">
      <div className="reveal-up max-w-4xl mx-auto">
        ...
        <button className="group relative px-16 py-6 bg-cyan-500 text-black font-black uppercase  text-sm rounded-full hover:bg-white transition-all duration-500 overflow-hidden shadow-[0_0_30px_rgba(6,182,212,0.4)]">
