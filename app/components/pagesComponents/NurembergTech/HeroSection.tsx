  ...
  return (
    <section className="relative min-h-[100vh] md:min-h-[90vh] flex items-center px-6 sm:px-10 md:px-20 overflow-hidden py-20 ">
      ...
      <div className="relative z-10 max-w-4xl w-full">
        ...
        {/* CTA Button - Full width on mobile option */}
        <button className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 bg-cyan-400 text-black font-black italic tracking-widest rounded-xl hover:bg-white active:scale-95 transition-all flex items-center justify-center gap-3 uppercase text-sm md:text-base">
          {texts.cta} 
          <ArrowRight 
            size={20} 
            className={`${locale === "ar" ? "rotate-180" : "rotate-0"} transition-transform`} 
          />
        </button>
      </div>
