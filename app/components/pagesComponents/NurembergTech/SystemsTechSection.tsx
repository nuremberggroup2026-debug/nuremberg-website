  ...
  return (
    <section className="py-16 px-4 md:px-10 bg-black">
      <div className="max-w-6xl mx-auto text-center mb-12">
        {locale === "en" ? (
          <h2 className="text-4xl md:text-6xl flex flex-row justify-center font-[1000] text-white italic uppercase tracking-tighter leading-none">
            <p>Our</p> <p className="text-cyan-400 px-1.5">Solutions</p>
          </h2>
        ) : (
        ...
        {data.cards.map((card: any, idx: number) => {
          ...
          return (
            ...
            >
              ...
              {card.desc && (
                <p className="text-white/40 text-sm mt-2">{card.desc}</p>
              )}
            </div>
          );
        })}
